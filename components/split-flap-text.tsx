...
const SPLIT_FLAP_FONT_SIZE = "clamp(3.6rem, 8.4vw, 9.6rem)";
...
function SplitFlapChar({ char, index, animationKey, skipEntrance, speed, playClick }: SplitFlapCharProps) {
    ...
    const bgColor = isSettled ? "hsl(0, 0%, 0%)" : "rgba(77, 166, 255, 0.2)";
    const textColor = isSettled ? "#ffffff" : "#4DA6FF";
    ...
    return (
        <motion.div
            ...
            className="relative flex items-center justify-center overflow-hidden font-(family-name:--font-bebas)"
            style={{
                fontSize: SPLIT_FLAP_FONT_SIZE,
                width: "0.65em",
                height: "1.05em",
        ...
        >
            <div className="absolute inset-x-0 top-1/2 z-10 h-px bg-black/20 pointer-events-none" />
